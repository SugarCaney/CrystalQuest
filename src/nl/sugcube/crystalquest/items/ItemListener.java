    ...
    public void onPlayerPickupItem(EntityPickupItemEvent event) {
        ...
        if (is.getItemMeta().hasDisplayName()) {
                ...
                if (chance > 0) {
                    ...
                    if (random <= chance * 10) {
                        ...
                        if (is.getType() == Material.DIAMOND_AXE) {
                            int damage = 1561 - (ran.nextInt(3) + 1);
                            ItemStack newIs = new ItemStack(is.getType(), 1);
                            Damageable damageable = (Damageable)newIs.getItemMeta();
            ...
            if (name.contains(Broadcast.get("items.crystal-shard"))) {
                ...
                a.setScore(team, a.getScore(team) + event.getItem().getItemStack().getAmount());
             ...
             */
                ...
                CrystalQuestTeam team = plugin.getArenaManager().getTeam(player);
                a.setScore(team, a.getScore(team) + event.getItem().getItemStack().getAmount() * 2);
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 20, 20);
            }
            /*
             * SHINY CRYSTAL
             */
                ...
                CrystalQuestTeam team = plugin.getArenaManager().getTeam(player);
                a.setScore(team, a.getScore(team) + event.getItem().getItemStack().getAmount() * 3);
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 20, 20);
            }
            /*
             * SHIELD
